...
auth_url = config['selectel']['auth_url']
username = config['selectel']['username']
password = config['selectel']['password']
user_domain_name = config['selectel']['user_domain_name']
project_domain_name = config['selectel']['project_domain_name']
...
def get_vm_selectel(orgname, region, provider, all_vms1):
...
#all_vms = get_vm_vmware('ru-2', 'SELECTEL', all_vms)
