...
for edge_gateway in edge_gateways:
    ...
    print(f"Processing Edge Gateway: {gateway.get('name')}")
    
    if hasattr(gateway_resource, 'Configuration'):
        print(f"Configuration found for {gateway.get('name')}")
        if hasattr(gateway_resource.Configuration, 'EdgeGatewayServiceConfiguration'):
            print(f"EdgeGatewayServiceConfiguration found for {gateway.get('name')}")
            ...
            print(f"No EdgeGatewayServiceConfiguration found for {gateway.get('name')}")
    else:
        print(f"No Configuration found for {gateway.get('name')}")
